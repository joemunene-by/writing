...
| [What I learned building a cybersecurity LLM from scratch](building-cybersecurity-llm-from-scratch.md) | The full GhostLM build journey: data quality over architecture, token-share vs record-count, a mode-collapsed eval, and hitting a 14.7M-parameter capacity ceiling. |
| [I found a bug that made my LLM look 14x better than it was](ghostlm-leaky-split-14x.md) | How a leaky random train/val split inflated GhostLM's numbers, and how a deterministic content-hash split made the eval honest again. |
